...
def get_tweet_full_text(tweet_obj) -> str:
    if not tweet_obj:
        return ""
    ...
    while SCHEDULER_STATE["is_running"]:
        ...
        try:
            ...
            for tweet in reversed(tweets):
                ...
                if retweeted_tweet:
                    raw_text = get_tweet_full_text(retweeted_tweet)
                    ...
                    raw_text = get_tweet_full_text(tweet)
                ...
                if quoted_tweet:
                    ...
                    quoted_raw_text = get_tweet_full_text(quoted_tweet)
